...
% Javier's Computer
     ...
     % Laptop
     %cd '/Volumes/EHDD1/Dropbox/WESTERN_ECONOMICS/RA_Baxter/Histogram_Iteration/Matlab_Code/Infinite_Horizon_Aiyagari'
...
% Model
Model = struct('p',par, ...
    'a_max', 120000, 'theta_a', 4.5, 'theta_a_f', 4.5, 'n_a',250, 'n_a_fine',500);
...
%Model.V = rand([Model.n_a, Model.n_eps, Model.n_zeta]); % Value function
Model.V = zeros([Model.n_a, Model.n_eps, Model.n_zeta]); % Value function
%Model.G_ap = rand([Model.n_a, Model.n_eps, Model.n_zeta]); % Policy Function for Capital/Assets
Model.G_ap = zeros([Model.n_a, Model.n_eps, Model.n_zeta]); % Policy Function for Capital/Assets
%Model.G_c = rand([Model.n_a, Model.n_eps, Model.n_zeta]); % Policy Function for Consumption
Model.G_c = zeros([Model.n_a, Model.n_eps, Model.n_zeta]); % Policy Function for Consumption
%Model.V_fine = rand([Model.n_a_fine, Model.n_eps, Model.n_zeta]); % Value function
Model.V_fine = zeros([Model.n_a_fine, Model.n_eps, Model.n_zeta]); % Value function
%Model.G_ap_fine = rand([Model.n_a_fine, Model.n_eps, Model.n_zeta]); % Policy Function for Capital/Assets
Model.G_ap_fine = zeros([Model.n_a_fine, Model.n_eps, Model.n_zeta]); % Policy Function for Capital/Assets
%Model.G_c_fine = rand([Model.n_a_fine, Model.n_eps, Model.n_zeta]); % Policy Function for Consumption
